    ...
    <div class="container">
      ...
      <div>
        <div>
          ...
          <input class="btn btn-large" type="button" value="Preview" onclick="$('#preview').load('preview.php', {action: 'preview', title: $('#title').val(), text: $('#text').val(), input: $('#input').val(), output: $('#output').val()});"/>
          ...
          <br/>
          Detailed problem: <span class="label label-info">Markdown formatting supported</span></br/><br/>
          <textarea style="height:400px;" class="span9" name="problem" placeholder="Add here..." id="text"></textarea><br/>
          </div>
          <div class="tab-pane" id="tab2">
